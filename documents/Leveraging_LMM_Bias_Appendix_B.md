...
[1](#appendix-b-scoring-rubrics-evaluation-framework)](#appendix-b-scoring-rubrics-evaluation-framework)

[B.1 Purpose of the Scoring Framework
[1](#b.1-purpose-of-the-scoring-framework)](#b.1-purpose-of-the-scoring-framework)

[B.2 Validity Rubric (Actual Method)
[1](#b.2-validity-rubric-actual-method)](#b.2-validity-rubric-actual-method)

[B.3 Soundness Rubric (Actual Method)
[2](#b.3-soundness-rubric-actual-method)](#b.3-soundness-rubric-actual-method)

[B.4 Premise Reliability Assessment (Actual Method)
[2](#b.4-premise-reliability-assessment-actual-method)](#b.4-premise-reliability-assessment-actual-method)

[B.5 Hidden Assumption Evaluation Rubric (Actual Method)
[3](#b.5-hidden-assumption-evaluation-rubric-actual-method)](#b.5-hidden-assumption-evaluation-rubric-actual-method)

[B.6 Inferential Strength Evaluation (Actual Method)
[3](#b.6-inferential-strength-evaluation-actual-method)](#b.6-inferential-strength-evaluation-actual-method)

[B.7 Stress-Test Rubric (Actual Method)
[3](#b.7-stress-test-rubric-actual-method)](#b.7-stress-test-rubric-actual-method)

[B.8 Logical Fallacy Identification Rubric (Actual Method)
[4](#b.8-logical-fallacy-identification-rubric-actual-method)](#b.8-logical-fallacy-identification-rubric-actual-method)

[B.9 Steelman Quality Rubric (Actual Method)
[4](#b.9-steelman-quality-rubric-actual-method)](#b.9-steelman-quality-rubric-actual-method)

[B.10 Final Verdict Rubric (Actual Method)
[5](#b.10-final-verdict-rubric-actual-method)](#b.10-final-verdict-rubric-actual-method)

[B.11 No Numerical Scoring or Weighting Was Used
[5](#b.11-no-numerical-scoring-or-weighting-was-used)](#b.11-no-numerical-scoring-or-weighting-was-used)
...
- Evaluations were qualitative, performed by comparing the model\'s
  logic to the argument\'s structure.
...
The reviewer made this determination based on the totality of Steps
1--14 (or 1--8).
...
Table : Summary Table
  ...
  **Category**       **Evaluation Basis**            **Method Used**
  ...
  Soundness          Premise truth & type            Qualitative
                                                     classification

  Premise            Evidence & support level        Qualitative
  Reliability                                        

  Hidden Assumptions Completeness & accuracy         Qualitative

  Inferential        Quality of intermediate         Qualitative
  Strength           reasoning                       

  Stress-Testing     Resilience under interpretation Qualitative
                     shifts                          

  Fallacy            Correct hits / false positives  Qualitative
  Identification                                     

  Steelman           Fidelity, clarity, improvement  Qualitative

  Final Verdict      Validity + soundness +          Pass / Partial Pass /
                     coherence                       Fail
  ------------------------------------------------------------------------
